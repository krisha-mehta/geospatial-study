...
## Task
On each trial, you will see a map of a state divided into counties. Your job is to choose the **three counties** that you think most urgently need additional resources. You should be 90% sure that the county you are choosing exceeds the 15% threshold level of acute poverty to successfully receive the funding.
